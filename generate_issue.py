...
4. Update every rendered number so it reflects the week's events: stock prices/trends, bounty statuses, faction postures, location statuses, and a fresh mpu_forecast (4 impacts with sector, lat, lon, eta_minutes, severity). DO NOT touch woolong_per — it is manually managed and locked.
...
- REGENERATE EVERY ISSUE: all eight news desks (astro, earth, econ, gate, bounty, mpu, citizen, biz), the DJ/broadcast patter, stocks, and mpu_forecast. Every article is fresh every week — nothing carries over verbatim, nothing goes stale.
...
EXCEPTIONS (first-person columns, allowed to be subjective and warmer): MPU's personal sign-off line and the three old men's op-ed. They may address the reader. MPU's forecast data and reporting stays objective; only its sign-off is free.
...
{"issue_meta":{"volume":N,"issue":N,"edition_label":"..."},
 "articles":[{"section":"astro|earth|econ|gate|bounty|mpu|citizen|biz","headline":"...","byline":"...","body":"...","image_brief":"..."}],
 ...
 "mpu_forecast":[{"sector":"...","lat":N,"lon":N,"eta_minutes":N,"severity":"..."}]}"""
